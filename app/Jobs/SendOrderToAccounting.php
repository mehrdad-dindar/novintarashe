    ...
    public function handle()
    {
        ...
        try {
            ...
            try {
                ...
                $response = $client->request('POST', 'http://srv3.noipservice.ir:7068/api/customer/register', $requestGmailData);
        ...
        // if (isset($trans) && $trans != null) {
            if ($order and $order->send_to_accounting == 0) {
                ...
                try {
                    ...
                    $response = $client->request('POST', 'http://srv3.noipservice.ir:7068/api/orders/save', $requestGmailData);
                    $response = $response->getBody()->getContents();
                    $response = json_decode($response);
                } catch (\GuzzleHttp\Exception\RequestException $e) {
