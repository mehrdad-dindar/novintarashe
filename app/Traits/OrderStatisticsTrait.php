    ...
    protected function orderValues(Request $request)
    {
        ...
        return response()->json(
            [
                'data' => $data,
                'meta' => [
                    'total'         => currencyTitle() . formatPriceUnits($total) . currencyTitle(),
                    'avg'           => currencyTitle() . formatPriceUnits($avg) . currencyTitle(),
                    'total_success' => currencyTitle() . formatPriceUnits($total_success) . currencyTitle(),
                    'total_fail'    => currencyTitle() . formatPriceUnits($total_fail) . currencyTitle()
                ],
                'status' => 'success',
            ],
        );
