...
class Order extends Model
{
    ...
    {
        return $this->morphMany(Transaction::class, 'transactionable')->where('status', true);
    }
    ...
    public function walletHistoryPaidOrder()
    {
        return $this->hasOne(WalletHistory::class)->where('status', 'success')->where('type' , '=' ,'type');
    }
