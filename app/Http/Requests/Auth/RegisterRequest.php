...
class RegisterRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'national_code.required' => 'لطفا یک کدملی معتبر وارد کنید',
            'national_code.string'   => 'لطفا یک کدملی معتبر وارد کنید',
            'national_code.regex'    => 'لطفا یک کدملی معتبر وارد کنید',
            'national_code.digits'   => 'لطفا یک کدملی معتبر وارد کنید',
            'national_code.unique'   => 'کدملی وارد شده تکراری است',
        ];
    }
