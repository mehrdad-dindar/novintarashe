                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="type" class="form-control" name="type">
                                                        <option {{ $user->type == 'user' ? 'selected' : '' }} value="user">کاربر عادی</option>
                                                        <option {{ $user->type == 'colleague' ? 'selected' : '' }} value="colleague">کاربر همکار</option>
                                                        <option {{ $user->type == 'vip' ? 'selected' : '' }} value="vip">کاربر ویژه</option>
                                                    </select>
                                                </div>
                                            </div>
...
{{--                                            </div>--}}
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" name="gateway_with_check" {{ $user->gateway_with_check=="active" ? 'checked' : '' }} value='active'>
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
