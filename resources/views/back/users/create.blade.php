                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ltr" name="mobile" required value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>کاربر به عنوان</label>
                                                    <select id="type" class="form-control" name="type">
                                                        <option value="user">کاربر عادی</option>
                                                        <option value="colleague">کاربر همکار</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group form-group">
                                                    <input readonly autocomplete="off" type="text" class="form-control" id="birthday_date_picker">
                                                    <input type="hidden" name="birthday" id="birthday_date">
...
{{--                                                        <input type="checkbox" name="colleague" value='colleague'>--}}
...
{{--                                            </div>--}}
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" name="gateway_with_check" value='active'>
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
