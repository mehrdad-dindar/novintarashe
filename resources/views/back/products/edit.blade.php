                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control product-category" name="category_id">
                                                                            ...
                                                                            @foreach ($categories as $category)
                                                                                <option
                                                                                    class="l{{ $category->getParents()->count() + 1 }} {{ $category->categories()->count() ? 'non-leaf' : '' }}"
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label>فروش محصول</label>

                                                                    <ul class="list-unstyled mb-0 mt-1">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input"  name="typeBuy" id="withCheck" value="withCheckAndCache" {{ $product->typeBuy == 'withCheckAndCache' ? 'checked' : '' }} >
                                                                                    <label class="custom-control-label" for="withCheck">چک و نقدی</label>
                                                                                </div>
                                                                            </fieldset>
                                                                        </li>
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="typeBuy" id="onlyCache" value="onlyCache" {{ $product->typeBuy == 'onlyCache' ? 'checked' : '' }}>
                                                                                    <label class="custom-control-label" for="onlyCache">فقط نقدی</label>
                                                                                </div>
                                                                            </fieldset>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount" class="form-control">
                                                                            ...
                                                                            <option data-value="100" value="100" {{ $product->rounding_amount == "100" ? 'selected' : '' }}>100 ریال</option>
                                                                            <option data-value="1000" value="1000" {{ $product->rounding_amount == "1000" ? 'selected' : '' }}>1000 ریال</option>
                                                                            <option data-value="10000" value="10000" {{ $product->rounding_amount == "10000" ? 'selected' : '' }}>10000 ریال</option>
                                                                            <option data-value="100000" value="100000" {{ $product->rounding_amount == "100000" ? 'selected' : '' }}>100000 ریال</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
