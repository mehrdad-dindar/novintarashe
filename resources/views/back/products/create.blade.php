                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <ul class="list-unstyled mb-0 mt-1">
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input"  name="typeBuy" id="withCheck" value="withCheckAndCache" checked="">
                                                                        ...
                                                                        <li class="d-inline-block mr-2">
                                                                            <fieldset>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="typeBuy" id="onlyCache" value="onlyCache">
