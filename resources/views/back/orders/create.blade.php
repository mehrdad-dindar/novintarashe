                                        ...
                                        <div class="tab-pane" id="order-info-tab-content" role="tabpanel" aria-labelledby="order-info-tab">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>تخفیف ({{currencyTitle()}})</label>
                                                            <input type="number" class="form-control amount-input" data-unit="{{currencyTitle()}}" name="discount_amount">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>هزینه ارسال ({{currencyTitle()}})</label>
                                                            <input type="number" class="form-control amount-input" data-unit="{{currencyTitle()}}" name="shipping_cost">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
