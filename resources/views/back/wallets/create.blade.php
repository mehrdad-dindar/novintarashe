            ...
            <div class="content-body">
                ...
                <section class="card">
                    <div class="card-header">
                        <h4 class="card-title">ایجاد تراکنش کیف پول (موجودی: {{ number_format($wallet->balance) }}
                            {{currencyTitle()}})</h4>
                        <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label>مبلغ </label>
                                                    <input type="number" class="form-control amount-input" data-unit="{{currencyTitle()}}" name="amount">
                                                </div>
                                            </div>
