        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{ Route::has('front.index') ? route('front.index') : url('/') }}" target="_blank">
                    <h2 class="brand-text mb-0">{{ option('info_site_title', 'فن وب') }}</h2>
                </a></li>
        </ul>
    </div>
...
{{--                        @endcan--}}
            ...
            @endcan
            @can('settings.sms')
                <li class="nav-item has-sub {{ open_class(['admin.messages.*']) }}"><a href="#"><i class="feather icon-mail"></i><span class="menu-title" > ارسال پیام</span></a>
                    <ul class="menu-content">
                        ...
                        {{--<li class="{{ active_class('admin.messages.birthday') }} nav-item">
                            <a href="{{ route('admin.messages.birthday') }}">
                                <i class="feather feather icon-circle"></i>
                                <span class="menu-title">تبریک تولد</span>
                            </a>
                        </li>--}}
                    </ul>
                </li>
