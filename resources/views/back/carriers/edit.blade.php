                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control amount-input" data-unit="{{currencyTitle()}}" name="free_shipping_price" value="{{ $carrier->free_shipping_price }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control amount-input" data-unit="{{currencyTitle()}}" name="extra_cost" value="{{ $carrier->extra_cost }}">
                                                                </div>
                                                            </div>
