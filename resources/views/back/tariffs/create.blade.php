                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-row-title">
                                <h3>{{ trans('front::messages.wallet.amount') }} ({{ trans('front::messages.currency.prefix') }}{{ currencyTitle() }})</h3>
                            </div>
                            <div class="form-row form-group">
                                <input type="number" class="input-ui pr-2 amount-input" data-unit="{{currencyTitle()}}" name="amount">
                            </div>
                        </div>
