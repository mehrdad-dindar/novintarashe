                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card user-statistics-card">
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 title="ارزش سفارشات: {{ number_format($orders_sum).' '.currencyTitle() }}" class="text-bold-700 mb-0">{{ formatPriceUnits($orders_sum) }}</h2>
                                                ...
                                                <tbody>
                                                    @foreach ($user->orders()->latest()->take(5)->get() as $order)
                                                        <tr>
                                                            ...
                                                            <td title="{{ convert_number($order->price).' '.currencyTitle() }} ">{{ number_format($order->price) }}</td>
