                        ...
                        @if($product->gallery()->count())
                            ...
                            @else
                                <div class="product-gallery mt-3">
                                    <div class="product-carousel owl-carousel">
                                        <div class="item">
                                            <a class="gallery-item mt-3" href="{{ asset($product->image) }}" data-fancybox="gallery" data-owl="one">
                                                <img src="{{ theme_asset('images/600-600.png') }}" data-src="{{ asset($product->image) }}" alt="{{ $product->title }}">
                                            </a>
                                        </div>
                                    </div>
                                    <hr class="border-product"/>
