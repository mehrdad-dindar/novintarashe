                ...
                <form id="profile-form" action="{{ route('front.user.profile.update') }}" class="setting_form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-4">
                            <div class="form-row-title">
                                <h3>{{ trans('front::messages.user.birthday') }}</h3>
                            </div>
                    ...
                    <div class='row mt-4'>
                        <div class="col-md-4 mb-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input attribute_group_input" value='1' name="notification" {{ $user->notification ? 'checked' : '' }} id="customCheck-1-0">
                                <label class="custom-control-label" for="customCheck-1-0">ارسال پیام و نوتیفیکیشن</label>
                            </div>
