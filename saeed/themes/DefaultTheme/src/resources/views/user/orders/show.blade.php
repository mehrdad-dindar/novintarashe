                    ...
                    <div class="row table-draught px-3">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            @if ($order->shipping_cost)
                                <span class="value">{{ trans('front::messages.currency.prefix') }}{{ number_format($order->shipping_cost) }}{{ currencyTitle() }}</span>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <span class="value">{{ trans('front::messages.currency.prefix') }}{{ number_format($order->totalDiscount()) }}{{ currencyTitle() }}</span>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <span class="title">{{ trans('front::messages.profile.total-price') }}</span>
                            <span class="value">{{ trans('front::messages.currency.prefix') }}{{ number_format($order->price) }} {{ currencyTitle() }}</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($order->items as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ trans('front::messages.currency.prefix') }}{{ number_format($item->quantity * $item->realPrice()) }} {{ currencyTitle() }}</td>
                                        <td>{{ $item->discount ? $item->discount . '%' : 0 }}</td>
                                        <td>{{ trans('front::messages.currency.prefix') }}{{ number_format($item->price * $item->quantity) }} {{ currencyTitle() }}</td>
                                        <td>
