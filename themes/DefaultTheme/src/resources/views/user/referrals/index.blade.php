                            ...
                            <table class="table table-order">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($refrrals as $refrral)
                                        @php
                                        if ($refrral->type=="percent"){
                                              $DiscountType="%";
                                        }{
                                              $DiscountType=' '.currencyTitle();
                                        }
                                        ...
                                        <tr>
                                            ...
                                            @if ($refrral->user_id == auth()->id())
                                                <td>{{ $refrral->userDiscount->code . '   ' . '(' . number_format($refrral->userDiscount->amount) . $DiscountType.')' }}</td>
                                            @else
                                                <td>{{ $refrral->referralDiscount->code . '   ' . '(' . number_format($refrral->referralDiscount->amount) . $DiscountType.')' }}</td>
                                            @endif
