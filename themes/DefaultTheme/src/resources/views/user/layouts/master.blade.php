                    ...
                    <div class="profile-sidebar dt-sl">
                        <div class="dt-sl dt-sn mb-3">
                            <div class="profile-sidebar-header dt-sl">
                                ...
                                <div title="{{ trans('front::messages.currency.prefix') . convert_number($user->getWallet()->balance()) .  currencyTitle()  }}" class="profile-point mt-3 mb-2 dt-sl">
                                    <span class="value-profile-point">{{ trans('front::messages.profile.wallet-balance') }}</span>
                                    <div class="float-left label-profile-point"><strong class="">{{ trans('front::messages.currency.prefix') }}{{ number_format($user->getWallet()->balance()) }}</strong> {{ currencyTitle() }}</div>
                                </div>
                            ...
                            <div class="profile-menu-section dt-sl">
                                ...
                                <div class="profile-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('front.user.messages.index') }}" class="{{ active_class('front.user.messages.index') }}">
                                                <i class="mdi mdi-comment"></i>
                                                 {{ trans('front::messages.profile.messages') }}
                                            </a>
                                        </li>
                                        <li>
