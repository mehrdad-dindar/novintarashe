                    ...
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <form id="register-form" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-row with-icon form-group">
                                ...
                                <i class="mdi mdi mdi-cellphone-android"></i>
                            </div>

                            <div class="form-row-title">
                                <h3>{{ trans('front::messages.auth.national-code') }}</h3>
                            </div>
                            <div class="form-row with-icon form-group">
                                <input type="text" name="national_code" class="input-ui pr-2" placeholder="{{ trans('front::messages.auth.enter-national-code') }}">
...
{{--                                    <input type="checkbox" name="colleague" class="custom-control-input" id="colleague">--}}
{{--                                    <label class="custom-control-label" for="colleague">--}}
