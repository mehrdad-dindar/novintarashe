                                                        ...
                                                        <form id="cart-update-form" action="{{ route('front.cart') }}" method="POST">
                                                            ...
                                                            @foreach($cart->products as $product)
                                                                ...
                                                                @php
                                                                    ...
                                                                    if($price_to_stock){
                                                                        $discountMajor = $price_to_stock->discountMajors->where('min', '<=', $product->pivot->quantity)->where('max', '>=', $product->pivot->quantity)->first();
                                                                ...
                                                                <div class="row list-row">
                                                                    ...
                                                                    <div class="col-8 col-sm-9 col-md-2 card-product-name">
                                                                        <a href="{{ route('front.products.show', ['product' => $product]) }}">
                                                                            <h3 class="title">{{ $product->title }}</h3>
                                                                        </a>

                                                                        @if ($product->isPhysical())
                                                                            @if(!is_null($price_to_stock))
