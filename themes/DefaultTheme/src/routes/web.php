...
Route::group(['as' => 'front.'], function () {
    ...
    Route::get('sitemap-category-products', [SitemapController::class, 'category_products']);
    ...
    Route::group(['middleware' => ['auth', 'verified', 'CheckPasswordChange']], function () {
        ...
        Route::get('user/messages', [UserController::class, 'messages'])->name('user.messages.index');
        Route::get('user/messages/show/{message}', [UserController::class, 'messages_show'])->name('user.messages.show');
