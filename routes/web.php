...
Route::group(['as' => 'admin.', 'prefix' => 'admin/' . admin_route_prefix(), 'middleware' => ['auth', 'Admin', 'verified', 'CheckPasswordChange', 'password.confirm']], function () {
    ...
    Route::post('settings/others/get-all-product', [SettingController::class, 'GetAllProductAccounting'])->name('settings.others.GetAllProductAccounting');
    Route::post('settings/others/get-new-product', [SettingController::class, 'GetNewProductAccounting'])->name('settings.others.GetNewProductAccounting');
    Route::post('settings/others/get-update-product', [SettingController::class, 'GetUpdateAccounting'])->name('settings.others.GetUpdateAccounting');
    Route::post('settings/others/apply-currency-products', [SettingController::class, 'apply_currency_products'])->name('settings.others.apply_currency_products');
...
Route::get('/factorNumber', function () {
    $trans = Transaction::where('factorNumber', 65)->first();

    dd($trans);
});

// Route::get('/order-register', function () {
//     $transactionId = 'c5N8PsqRbBuu9IkpdI7ljOE9BxnvcS5qUB4J02pf/njPHklsslZL0SnwA/V4j0wcD9jdMowHHHHM/l2oW7z/LQ';
//     $transaction = Transaction::where('transID', $transactionId)->firstOrFail();
...
Route::get('/get-all-product', [SettingController::class, 'GetAllProductAccounting']);
Route::get('/get-update-product', [SettingController::class, 'GetUpdateAccounting']);
// Route::get('/apply-currency-products', [SettingController::class, 'apply_currency_products']);
