...
function addProductPrice() {
    ...
    price
        ...
        .attr('name', 'prices[' + count + '][title]');

    price
        .find('input[name="min[]"]')
        .attr('name', 'prices[' + count + '][min][]');
    price
        .find('input[name="max[]"]')
        .attr('name', 'prices[' + count + '][max][]');

    price
        .find('input[name="discount_major[]"]')
        .attr('name', 'prices[' + count + '][discount_major][]');
...
$(document).on(
    ...
    function () {
        ...
        let finalPriceText = number_format(finalPrice) + ' '+ title;
